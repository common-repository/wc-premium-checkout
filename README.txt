...
3. In the search field enter "WPC - Checkout Editor for WooCommerce". 
...
1. Screenshot Onepage Checkout Lite Version
...
= 1.0.2 =
* Logo position control added.

= 1.0.5 =
* Fix errors for PHP 7.4.X.
...
= 1.2.8 =
* Hide address section when there are no shipping fields.
* Update fields manager controls.
* Fix bugs.

= 1.3.4 =
* New compatibility feature for remove woocommerce template hooks.
* Fix bugs.

= 1.3.6 =
* Improved compatibility on different themes
* Fix bugs.
